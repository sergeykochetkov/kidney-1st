...
def get_config():
    config = {
        ...
        'pseudo_label_path':'../../../input/d48_hand_labelled.csv',
...
if __name__=='__main__':
    ...
    pseudo_df = pseudo_df[['id','predicted']].copy().rename(columns={'predicted':'encoding'})
    ...
    for idx,filename in enumerate(pseudo_df['id'].values):
        ...
        ds = HuBMAPDataset(pseudo_df, filename, config, mode='test')
