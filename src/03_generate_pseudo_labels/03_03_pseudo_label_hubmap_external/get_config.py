...
mapper = {
    ...
    'external': {  # 2 in total
        ...
        'VAN0003-LK-33-2-PAS_FFPE.ome.tif': None,
        'VAN0005-RK-1-1-PAS_registered.ome.tif': None,
        'VAN0005-RK-4-172-PAS_registered.ome.tif': None,
        'VAN0005-RK-8-2-PAS_FFPE.ome.tif': None,
...
def get_config():
    config = {
        ...
        'external_data_path': '/mnt/750G/GIT/kidney_unlabeled',
        'split_seed_list': [0],
        'FOLD_LIST': [0, 1, 2, 3],
